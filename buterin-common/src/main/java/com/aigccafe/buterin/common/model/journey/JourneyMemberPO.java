...
public class JourneyMemberPO implements Serializable {
    private Long id;
    ...
    public Integer getFastTimes() {
        return fastTimes;
    }

    public void setFastTimes(Integer fastTimes) {
    ...
    public boolean equals(Object that) {
        ...
        JourneyMemberPO other = (JourneyMemberPO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getFastTimes() == null ? other.getFastTimes() == null : this.getFastTimes().equals(other.getFastTimes()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFastTimes() == null) ? 0 : getFastTimes().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", fastTimes=").append(fastTimes);
